...
urlpatterns = [
    ...
    path(
        "loans/penalties/<int:pk>/waive/",
        AdminWaivePenaltyView.as_view(),
        name="admin_waive_penalty",
    ),
    ...
    path(
        ...
        name="admin_notification_stats",
    ),
    path(
        "notifications/send-reminder/",
        AdminSendReminderView.as_view(),
        name="admin_send_reminder",
    ),
    # Statistics
    path(
        "stats/dashboard/", AdminDashboardView.as_view(), name="admin_stats_dashboard"
    ),
    path(
        "stats/loans-per-month/",
        AdminLoansPerMonthView.as_view(),
        name="admin_stats_loans_per_month",
    ),
    path(
        "stats/most-borrowed-books/",
        AdminMostBorrowedBooksView.as_view(),
        name="admin_stats_most_borrowed_books",
    ),
    path(
        "stats/most-borrowed-genres/",
        AdminMostBorrowedGenresView.as_view(),
        name="admin_stats_most_borrowed_genres",
    ),
    path(
        "stats/overdue-report/",
        AdminOverdueReportView.as_view(),
        name="admin_stats_overdue_report",
    ),
    path(
        "stats/popular-books/",
        AdminPopularBooksView.as_view(),
        name="admin_stats_popular_books",
    ),
    path(
        "stats/notifications/",
        AdminStatsNotificationsView.as_view(),
        name="admin_stats_notifications",
    ),
]
